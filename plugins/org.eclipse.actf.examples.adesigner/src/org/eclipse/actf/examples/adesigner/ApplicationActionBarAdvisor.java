...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menuBar) {
		...
		// File
		MenuManager fileMenu = new MenuManager(ADesignerPlugin
				.getResourceString("adesigner.menu.file"),
		...
		// Tool
		MenuManager toolMenu = new MenuManager(ADesignerPlugin
				.getResourceString("adesigner.menu.viz"), "visualization");
		...
		// Window
		MenuManager windowMenu = new MenuManager(ADesignerPlugin
				.getResourceString("adesigner.menu.window"),
				IWorkbenchActionConstants.M_WINDOW);
		windowMenu.add(new Separator());
		MenuManager navigationMenu = new MenuManager(ADesignerPlugin
				.getResourceString("adesigner.menu.navigation"),
				"navigationMenu");
		...
		MenuManager helpMenu = new MenuManager(ADesignerPlugin
				.getResourceString("adesigner.menu.help"),
